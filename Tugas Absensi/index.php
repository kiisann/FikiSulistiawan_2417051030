...
<form method="POST">
    Nama: <input type="text" name="nama" required value="<?= $editdata ? htmlspecialchars($editdata['nama']) : '' ?>">
    NPM: <input type="text" name="npm" required value="<?= $editdata ? htmlspecialchars($editdata['npm']) : '' ?>">
